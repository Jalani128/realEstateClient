    ...
    <div className="w-[359px] bg-white border-r border-[#E6E0DA] h-screen sticky top-20 overflow-y-auto pb-24">
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            onClick={handleReset}
            className="font-manrope font-extralight text-sm text-[#2E3192] hover:underline"
          >
            Reset all
          </button>
        </div>
        ...
        <div className="mb-8 border-b border-[#F5F1E8] pb-8">
          ...
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full bg-[#F5F1E8] border border-[#EBE5DE] rounded-lg pl-10 pr-4 py-3 font-manrope text-sm text-[#111827] placeholder:text-[#6B7280] focus:outline-none focus:border-[#2E3192] transition-all"
            />
          </div>
        </div>
              ...
              <button
                ...
                className={`flex-1 h-11 rounded-xl border font-manrope font-bold text-sm transition-all ${
                  selectedAvailability === avail.id
                    ? 'bg-[#2E3192] border-[#2E3192] text-white shadow-md'
                    : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#2E3192] hover:text-[#2E3192]'
                }`}
              >
                {avail.label}
              </button>
        ...
        <div className="mb-8 border-b border-[#F5F1E8] pb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="font-space-mono text-sm text-[#2E3192]">
          ...
          <div className="relative mb-4 px-2">
            <input
              ...
              className="w-full h-1.5 bg-[#E6E0DA] rounded-full appearance-none cursor-pointer accent-[#2E3192]"
            />
          </div>
              ...
              <button
                ...
                className={`flex-1 h-10 rounded-lg font-manrope font-bold text-sm border transition-all ${
                  bedrooms === num
                    ...
                    : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#2E3192]'
                }`}
              >
              ...
              <label 
                ...
                className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                  selectedAmenities.includes(amenity)
                    ? 'bg-[rgba(212,117,91,0.05)] border-[#2E3192]'
                    : 'bg-white border-[#E6E0DA] hover:border-[#2E3192]'
                }`}
              >
                <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${
                  selectedAmenities.includes(amenity)
                    ? 'bg-[#2E3192] border-[#2E3192]'
                ...
                <span className={`font-manrope text-sm ${
                   selectedAmenities.includes(amenity) ? 'text-[#2E3192] font-semibold' : 'text-[#4B5563]'
                }`}>
                  {amenity}
                </span>
              </label>
        ...
        <button
          onClick={handleReset}
          className="w-full bg-white border border-[#2E3192] text-[#2E3192] font-manrope font-bold text-base py-4 rounded-xl transition-all hover:bg-[#2E3192] hover:text-white sticky bottom-0"
        >
          Reset Filters
        </button>
      </div>
